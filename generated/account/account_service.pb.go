...
const file_account_service_proto_rawDesc = "" +
	...
	"\x04user\x18\x02 \x01(\v2\x13.account.UpdateUserR\x04user2\x8a\x04\n" +
	"\aAccount\x12f\n" +
	"\n" +
	"CreateUser\x12\x1a.account.CreateUserRequest\x1a\x1b.account.CreateUserResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14account/api/v1/users\x12d\n" +
	...
	"\n" +
	"DeleteUser\x12\x1a.account.DeleteUserRequest\x1a\x16.google.protobuf.Empty\"&\x82\xd3\xe4\x93\x02 *\x1eaccount/api/v1/users/{user_id}\x12h\n" +
	"\n" +
	"UpdateUser\x12\x1a.account.UpdateUserRequest\x1a\x16.google.protobuf.Empty\"&\x82\xd3\xe4\x93\x02 \x1a\x1eaccount/api/v1/users/{user_id}B?Z=github.com/Molov30/go-microservices/generated/account;accountb\x06proto3"
...
var file_account_service_proto_goTypes = []any{
	...
	(*pagination.Pagination)(nil), // 10: pagination.Pagination
...
var file_account_service_proto_depIdxs = []int32{
	...
	11, // 6: account.UpdateUserRequest.user:type_name -> account.UpdateUser
	...
	12, // 15: account.Account.DeleteUser:output_type -> google.protobuf.Empty
	12, // 16: account.Account.UpdateUser:output_type -> google.protobuf.Empty
