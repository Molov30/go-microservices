...
const file_account_service_proto_rawDesc = "" +
	...
	"\x04user\x18\x02 \x01(\v2\x13.account.UpdateUserR\x04user2\x85\x04\n" +
	"\aAccount\x12a\n" +
	"\n" +
	"CreateUser\x12\x1a.account.CreateUserRequest\x1a\x16.google.protobuf.Empty\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14account/api/v1/users\x12d\n" +
...
var file_account_service_proto_goTypes = []any{
	...
	(*UpdateUser)(nil),            // 10: account.UpdateUser
...
var file_account_service_proto_depIdxs = []int32{
	...
	10, // 5: account.UpdateUserRequest.user:type_name -> account.UpdateUser
	...
	11, // 14: account.Account.DeleteUser:output_type -> google.protobuf.Empty
